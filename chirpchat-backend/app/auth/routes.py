...
async def login(
    ...
    if settings.NOTIFICATION_EMAIL_TO:
        ...
        logger.info(f"NOTIFICATION_EMAIL_TO not set. Skipping login notification email for user: {user_in_db['display_name']}")
...
async def update_profile(
    ...
    if "mood" in update_data and "mood" in refreshed_user_data and updated_data["mood"] != current_user.mood :
